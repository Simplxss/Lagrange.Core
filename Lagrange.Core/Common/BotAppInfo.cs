...
public class BotAppInfo
{
    ...
    private static readonly BotAppInfo AndroidPhone = new()
    {
        ...
        BaseVersion = "9.1.35",
        CurrentVersion = "A9.1.30.a920c625",
        BuildVersion = 15962,
        PtVersion = "9.1.35",
        PtOsVersion = 23,
        PackageName = "com.tencent.mobileqq",
        PackageSign = "V1_AND_SQ_9.1.35_8666_HDBM_T",
        AppId = 16,
        SubAppId = 537265114,
    ...
    private static readonly BotAppInfo AndroidPad = new()
    {
        ...
        BaseVersion = "9.1.30",
        CurrentVersion = "A9.1.30.705d26da",
        BuildVersion = 15962,
        PtVersion = "9.1.30",
        PtOsVersion = 23,
        PackageName = "com.tencent.mobileqq",
        PackageSign = "V1_AND_SQ_9.1.30_8496_HDBM_T",
        AppId = 16,
        SubAppId = 537242115,
        AppKey = "0S200MNJT807V3GE",
        ApkSignatureMd5 = new byte[] { 0xA6, 0xB7, 0x45, 0xBF, 0x24, 0xA2, 0xC2, 0x77, 0x52, 0x77, 0x16, 0xF6, 0xF3, 0x6E, 0xB6, 0x8D },
