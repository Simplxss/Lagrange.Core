...
internal class FetchUserInfoService : BaseService<FetchUserInfoEvent>
{
    ...
    {
        // var keys = new List<uint> { 20002, 41305, 40410, 42031, 27025, 27406 };

        // var packet = new OidbSvcTrpcTcpBase<OidbSvcTrpcTcp0xFE1_8>(new OidbSvcTrpcTcp0xFE1_8
        // {
        //     Uid = input.Uid,
        //     Field2 = 0,
        //     Keys = new OidbSvcTrpcTcp0xFE1_8Key
        //     {
        //         Key = keys,
        //         Field3 = 2
        //     }
