...
internal class ExchangeEmp0x000FV2 : ExchangeEmp
{
    private const ushort ExchangeCommand = 0x000F;

    private int SsoSeq;

    public ExchangeEmp0x000FV2(BotKeystore keystore, BotAppInfo appInfo, BotDeviceInfo device, int ssoSeq)
    ...
    protected override BinaryPacket ConstructTlv() => new BinaryPacket()
        ...
        .WritePacket(new TlvPacket(0x143, new Tlv143(Keystore)))
